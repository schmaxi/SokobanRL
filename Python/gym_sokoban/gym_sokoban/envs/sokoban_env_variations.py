...
from .sokoban_env_same_level import SokobanEnvSameLevel
from .sokoban_env_qlearning import SokobanEnvQLearningSameLevel
...
class SokobanEnv1(SokobanEnv):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs['max_steps'] = kwargs.get('max_steps', 500)
...
class SokobanEnvSameLevel(SokobanEnvSameLevel):
    metadata = {
        'render.modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array', 'greyscale'],
        'render_modes': ['human', 'rgb_array', 'tiny_human', 'tiny_rgb_array', 'greyscale'],
    }
    ...
    def __init__(self, **kwargs):
        ...
        kwargs['max_steps'] = kwargs.get('max_steps', 500)
        kwargs['num_gen_steps'] = kwargs.get('num_gen_steps', 40)
        super(SokobanEnvSameLevel, self).__init__(**kwargs)
...
class SokobanEnvQLearningSameLevel(SokobanEnv):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs['max_steps'] = kwargs.get('max_steps', 200)
        kwargs['num_gen_steps'] = kwargs.get('num_gen_steps', 40)
        super(SokobanEnvQLearningSameLevel, self).__init__(**kwargs)
